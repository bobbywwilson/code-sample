    ...
    $.ajax({
        ...
        success: function success(data) {
            ...
            for (i; i < dataLength; i += 1) {
                ...
                stochastic.push([data[i][0], // the date
                data[i][1], // open
                data[i][2], // high
                data[i][3], // low
                data[i][4] // close
            ...
            Highcharts.stockChart('chart', {
                ...
                if ($(window).width() <= 667) {
                    ...
                    chart.renderer.text('MACD (12, 26)', 5, 348).attr({
                        rotation: 0
                    }).css({
                        color: '#000000',
                        fontSize: '12px'
                    ...
                    chart.renderer.text('RSI (14, 28)', 5, 490).attr({
                        rotation: 0
                    }).css({
                        color: '#000000',
                        fontSize: '12px'
                    ...
                    chart.renderer.text('STOCHASTIC (14, 3)', 5, 591).attr({
                        rotation: 0
                    }).css({
                        color: '#000000',
                        fontSize: '12px'
                    ...
                    chart.renderer.text('MACD (12, 26)', 5, 340).attr({
                        rotation: 0
                    }).css({
                        color: '#000000',
                        fontSize: '12px'
                    ...
                    chart.renderer.text('RSI (14, 28)', 5, 465).attr({
                        rotation: 0
                    }).css({
                        color: '#000000',
                        fontSize: '12px'
                    ...
                    chart.renderer.text('STOCHASTIC (14, 3)', 5, 590).attr({
                        rotation: 0
                    }).css({
                        color: '#000000',
                        fontSize: '12px'
