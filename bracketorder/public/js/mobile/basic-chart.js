        ...
        success: function success(data) {
            ...
            Highcharts.stockChart('chart', {
                ...
                xAxis: [{
                    ...
                    events: {
                        afterSetExtremes: function afterSetExtremes() {
                            ...
                            // volume_value = prices[prices.length - 1].x;
                            ...
                            trade_time = moment(ohlc[ohlc.length - 1][0]).format("h:mm:ss");
                            ...
                            if (Math.sign(change) === -1) {
                                $('.change').html(Math.abs(formatNumber(change.toFixed(2))));
                                $('.change').addClass('red-indicator').removeClass('silver-indicator').removeClass('green-indicator');
                                $('.indicator-color').addClass('fas fa-caret-down red-indicator').removeClass('fas fa-caret-up green-indicator').removeClass('fas fa-caret-up silver-indicator');
                            } else if (Math.sign(change) === 1) {
                                $('.change').html(Math.abs(formatNumber(change.toFixed(2))));
                                $('.change').addClass('green-indicator').removeClass('silver-indicator').removeClass('red-indicator');
                                $('.indicator-color').addClass('fas fa-caret-up green-indicator').removeClass('fas fa-caret-down red-indicator').removeClass('fas fa-caret-down silver-indicator');
                            } else if (Math.sign(change) === 0) {
                                $('.change').html(Math.abs(formatNumber(change.toFixed(2))));
                                $('.change').addClass('silver-indicator').removeClass('red-indicator').removeClass('green-indicator');
                                $('.indicator-color').addClass('silver-indicator').removeClass('fas fa-caret-up').removeClass('fas fa-caret-down').removeClass('silver-indicator').removeClass('red-indicator').removeClass('green-indicator');
                            }
                            $('.percent-change').html(formatNumber(percent_change.toFixed(2)) + "%");
                            if (Math.sign(percent_change) === -1) {
                                $('.percent-change').html(Math.abs(formatNumber(percent_change.toFixed(2))) + "%");
                                $('.percent-change').addClass('red-indicator').removeClass('silver-indicator').removeClass('green-indicator');
                                $('.indicator-color').addClass('fas fa-caret-down red-indicator').removeClass('silver-indicator').removeClass('green-indicator');
                            } else if (Math.sign(percent_change) === 1) {
                                $('.percent-change').html(Math.abs(formatNumber(percent_change.toFixed(2))) + "%");
                                $('.percent-change').addClass('green-indicator').removeClass('silver-indicator').removeClass('red-indicator');
                                $('.indicator-color').addClass('fas fa-caret-up green-indicator').removeClass('silver-indicator').removeClass('red-indicator');
                            } else if (Math.sign(percent_change) === 0) {
                                $('.percent-change').html(Math.abs(formatNumber(percent_change.toFixed(2))) + "%");
                                $('.percent-change').addClass('silver-indicator').removeClass('silver-indicator').removeClass('green-indicator');
                                $('.indicator-color').addClass('silver-indicator').removeClass('fas fa-caret-up').removeClass('fas fa-caret-down').removeClass('silver-indicator').removeClass('red-indicator').removeClass('green-indicator');
                            }
                            ...
                            // let full_date = month[sd.getMonth()] + '/' + day[sd.getDate()] + '/' + sd.getFullYear().toString().substr(-2);
                            ...
                            i = 0;
                            for (i; i < 5; i += 1) {
                                ohlc.push([ohlc[ohlc.length - 1][0] += 1000 * 60 * 60 * 24 * 1, // the date
                                // null
                                null, // open
                                null, // high
                                null, // low
                ...
                if ($(window).width() <= 667) {
                    ...
                    chart.renderer.text('<i class="fas fa-square white-indicator"></i> ' + stock_code[0].toUpperCase() + '<span class="white-indicator spacer close-price">' + formatNumber(ohlc_chart.y.toFixed(2)) + '</span>', 3, 75, true).attr({
                        rotation: 0
                    }).css({
                        color: '#707073',
                        fontSize: '12px'
                    ...
                    chart.renderer.text('<i class="fas fa-square blue-indicator"></i> Volume <span class="white-indicator volume-value spacer" id="volume">' + formatNumber(volume_value) + '</span>', 3, 272, true).attr({
                        rotation: 0
                    }).css({
                        color: '#707073',
                        fontSize: '12px'
                    ...
                    chart.renderer.text('<i class="fas fa-square green-indicator"></i> MACD <span class="white-indicator macd-value spacer">' + macd_value.toFixed(2) + '</span>', 3, 357, true).attr({
                        rotation: 0
                    }).css({
                        color: '#707073',
                        fontSize: '12px'
                    ...
                    chart.renderer.text('<i class="fas fa-square grey-indicator spacer"></i> Signal <span class="white-indicator macd-signal spacer">' + signal_value.toFixed(2) + '</span>', 100, 357, true).attr({
                        rotation: 0
                    }).css({
                        color: '#707073',
                        fontSize: '12px'
                    ...
                    chart.renderer.text('<i class="fas fa-square blue-indicator spacer"></i> Divergence <span class="white-indicator macd-divergence spacer">' + divergence_value.toFixed(2) + '</span>', 200, 357, true).attr({
                        rotation: 0
                    }).css({
                        color: '#707073',
                        fontSize: '12px'
                    ...
                    chart.renderer.text('<i class="fas fa-square white-indicator"></i> ' + stock_code[0].toUpperCase() + ' US Equity <span class="white-indicator spacer close-price">' + formatNumber(ohlc_chart.y.toFixed(2)) + '</span>', 3, 75, true).attr({
                        rotation: 0
                    }).css({
                        color: '#707073',
                        fontSize: '12px'
                    ...
                    chart.renderer.text('<i class="fas fa-square grey-indicator spacer"></i> Signal <span class="swhite-indicator macd-signal spacer">' + signal_value.toFixed(2) + '</span>', 100, 357, true).attr({
                        rotation: 0
                    }).css({
                        color: '#707073',
                        fontSize: '12px'
