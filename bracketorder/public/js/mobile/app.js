...
$(document).ready(function () {
    ...
    var $body = $("body");
    var user_id = $('#user_id_bracket').val();
...
$(document).on('submit', '#bracketorder-form', function (e) {
    ...
    var cc_autoload = autoload[1];
    var bitcoin = cc_autoload.split(" - ");
...
$(document).on('click', '#save-chart', function (e) {
    ...
    var sma_periods_1 = $('#periods-sma-1').val();
    var sma_periods_2 = $('#periods-sma-2').val();
    var sma_periods_3 = $('#periods-sma-3').val();

    var sma_color_1 = $('#sma-color-1').val();
    var sma_color_2 = $('#sma-color-2').val();
    var sma_color_3 = $('#sma-color-3').val();
...
$(document).mouseup(function (e) {
    ...
    var lose_focus_news = $(".close-news");

    var lose_focus_sma_1 = $('#periods-sma-1');

    var lose_focus_sma_2 = $('#periods-sma-2');

    var lose_focus_sma_3 = $('#periods-sma-3');

    if (lose_focus_sma_1.is(e.target) && lose_focus_sma_1.has(e.target).length !== 0) {
        var is_empty = $('#periods-sma-1').hasClass('validate valid');
        if (is_empty) {
            $('#periods-sma-1-label').addClass('active');
        } else {
    ...
    if (!lose_focus_sma_2.is(e.target) && lose_focus_sma_2.has(e.target).length === 0) {
        var _is_empty = $('#periods-sma-2').hasClass('validate valid');
        if (_is_empty) {
            $('#periods-sma-2-label').addClass('active');
        } else {
    ...
    if (!lose_focus_sma_3.is(e.target) && lose_focus_sma_3.has(e.target).length === 0) {
        var _is_empty2 = $('#periods-sma-3').hasClass('validate valid');
        if (_is_empty2) {
            $('#periods-sma-3-label').addClass('active');
        } else {
