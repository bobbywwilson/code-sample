        ...
        success: function (data) {
            ...
            Highcharts.stockChart('chart', {
                ...
                if ($(window).width() <= 667){
                    ...
                    chart.renderer.text('<i class="fas fa-square white-indicator"></i> ' + stock_code[0].toUpperCase() + '<span class="white-indicator spacer close-price">' + formatNumber(ohlc_chart.y.toFixed(2)) + '</span>', 3, 75, true)
                        .attr({
                            rotation: 0
                        })
                        .css({
                    ...
                    chart.renderer.text('<i class="fas fa-square blue-indicator"></i> Volume <span class="white-indicator volume-value spacer" id="volume">' + formatNumber(volume_value) + '</span>', 3, 272, true)
                        .attr({
                            rotation: 0
                        })
                        .css({
                        ...
                        chart.renderer.text('<i class="fas fa-square green-indicator"></i> MACD <span class="white-indicator macd-value spacer">' + macd_value.toFixed(2) + '</span>', 3, 357, true)
                        .attr({
                            rotation: 0
                        })
                        .css({
                    ...
                    chart.renderer.text('<i class="fas fa-square grey-indicator spacer"></i> Signal <span class="white-indicator macd-signal spacer">' + signal_value.toFixed(2) + '</span>', 100, 357, true)
                        .attr({
                            rotation: 0
                        })
                        .css({
                    ...
                    chart.renderer.text('<i class="fas fa-square blue-indicator spacer"></i> Divergence <span class="white-indicator macd-divergence spacer">'  + divergence_value.toFixed(2) + '</span>', 200, 357, true)
                        .attr({
                            rotation: 0
                        })
                        .css({
                    ...
                    chart.renderer.text('<i class="fas fa-square white-indicator"></i> ' + stock_code[0].toUpperCase() + ' US Equity <span class="white-indicator spacer close-price">' + formatNumber(ohlc_chart.y.toFixed(2)) + '</span>', 3, 75, true)
                        .attr({
                            rotation: 0
                        })
                        .css({
                    ...
                    chart.renderer.text('<i class="fas fa-square grey-indicator spacer"></i> Signal <span class="swhite-indicator macd-signal spacer">' + signal_value.toFixed(2) + '</span>', 100, 357, true)
                        .attr({
                            rotation: 0
                        })
                        .css({
