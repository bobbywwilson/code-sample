            ...
            <div class="card">
                ...
                <div class="card-content" id="chart-card">
                    ...
                    <div class="row">
                        ...
                        <div class="col s3 no-padding-left">
                            <h6 class="red-indicator"><i class="fas fa-caret-down"></i> .215</h6>
                        </div>
                        <div class="col s3 no-padding-left">
                            <h6 class="red-indicator"><i class="fas fa-caret-down"></i> .12%</h6>
                        </div>
                        <div class="col s3 no-padding-left margin-bottom-10">
                            <h6 class="grey-indicator">7:30 PM EST</h6>
                        </div>

                        <div class="col s12 no-padding-left">
                            <h6 class="yellow-indicator">Price Chart</h6>
                        </div>
